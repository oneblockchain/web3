  ...
  return (
    <Card {...rest} maxH="max-content">
      ...
      <Text color={textColor} fontSize="md" fontWeight="400" mb="50px">
        ...
        followers into paying customers, how to attract 20,000 real followers to
        your account and how to convert your new Instagram followers to
      ...
      <Card bg={bg} p="18px" maxW={{ base: '400px' }}>
        <Image src={diploma} borderRadius="14px" alt="" />
      </Card>
      <Flex
        mt="10px"
